...
import com.rb.sss.service.ServDemo1010Service;
import com.rb.core.rest.ConfigIdentifier;
import com.rb.core.rest.GenericApi;

@Path("/api/v1/employees")
public class ServDemo1010Controller {

    public static final Logger logger = LoggerFactory.getLogger(ServDemo1010Controller.class);
	@Inject
	ServDemo1010Service service;
